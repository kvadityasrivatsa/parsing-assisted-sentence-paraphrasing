...
--trainpref extracted_data/vanilla.train \
--validpref extracted_data/vanilla.dev \
--testpref extracted_data/vanilla.test \
...
--checkpoint-suffix '.vanilla' --no-epoch-checkpoints
